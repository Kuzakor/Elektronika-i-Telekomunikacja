...
#matematyka #analiza
# Definicja
- Funkcja wykładnicza [[Pochodna|rośnie]] z "prędkością" równą jej samej wyskalowaną o stały współczynnik (lna)
...
# Wzór
$$a\in R \Rightarrow f(x) = a^{x}$$
$$\frac{d}{dx}a^{x}= a^{x}*ln(a)$$
$$\frac{d}{dx}e^{x}= e^x$$
$$a^{x}= e^{ln(a)x}$$

# Opis
ln(a) - [[Logarytm|Logarytm naturalny]]