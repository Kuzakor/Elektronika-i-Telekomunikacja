...
# Co i jak
Każdy *liniowy* układ równań można zapisać w postaci mnożenia (zastosowania) [[Macierz jako liniowe przekrztałcenie|macierzy przez wektor]]  gdzie wynikiem jest wektor po przekrztałceniu.
# Przykład
